...
public class EmpruntRest {
    ...
    @PutMapping("/ref/{ref}/dateRetourEffective/{dateRetourEffective}")
    public int restituer(@PathVariable String ref,@PathVariable @DateTimeFormat(pattern = "dd-MM-yyyy") Date dateRetourEffective) {
        return empruntService.restituer(ref, dateRetourEffective);
    }
