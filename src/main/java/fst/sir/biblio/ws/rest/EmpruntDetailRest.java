...
public class EmpruntDetailRest {
    ...
    public int save(@RequestBody Emprunt emprunt) {
        return empruntDetailService.save(emprunt, emprunt.getEmpruntDetails());
    }

//    @GetMapping("/")
//    public boolean validateEmpruntDetail(@RequestBody Emprunt emprunt) {
//        return empruntDetailService.validateEmpruntDetail(emprunt, emprunt.getEmpruntDetails());
